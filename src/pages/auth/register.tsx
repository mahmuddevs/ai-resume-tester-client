...
import { LockIcon, EnvelopeSimpleIcon, WarningCircleIcon, CircleNotchIcon, UserIcon, EyeIcon, EyeSlashIcon } from '@phosphor-icons/react';
...
export default function Register() {
  ...
  const handleRegisterSubmit = async (data: RegisterFormInputs) => {
    ...
    try {
      const res = await getFetch<{ data: { user: User } }>('/auth/register', {
        method: 'POST',
        body: {
        ...
        <div className="relative z-10 my-auto space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-white!">
              ...
              <span className="bg-linear-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent font-black">ATS-optimized</span>
              <span className="text-white"> resume in minutes.</span>
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed max-w-md">
              Unlock powerful analysis metrics, keyword tailoring, and direct scoring comparisons to match top industry roles.
            </p>
          </div>
        ...
        <div className="w-full max-w-md space-y-8 z-10">
          ...
          <div className="space-y-2.5">
            ...
            <p className="text-sm font-medium text-slate-500 leading-relaxed">
              Get started by creating your workspace account.
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit(handleRegisterSubmit)}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="John"
                    disabled={loading}
                    className={`w-full rounded-xl border px-4 py-3 pl-10 text-sm text-slate-950 placeholder-slate-400 bg-white shadow-xs outline-none transition focus:ring-4 disabled:bg-slate-100 disabled:opacity-50 ${errors.firstName
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Doe"
                    disabled={loading}
                    className={`w-full rounded-xl border px-4 py-3 pl-10 text-sm text-slate-950 placeholder-slate-400 bg-white shadow-xs outline-none transition focus:ring-4 disabled:bg-slate-100 disabled:opacity-50 ${errors.lastName
                      ? 'border-brand-danger focus:border-brand-danger focus:ring-brand-danger/10'
                      : 'border-slate-200 focus:border-indigo-600 focus:ring-indigo-600/10'
                      }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  disabled={loading}
                  className={`w-full rounded-xl border px-4 pr-10 py-3 pl-10 text-sm text-slate-950 placeholder-slate-400 bg-white shadow-xs outline-none transition focus:ring-4 disabled:bg-slate-100 disabled:opacity-50 ${errors.confirmPassword
                    ? 'border-brand-danger focus:border-brand-danger focus:ring-brand-danger/10'
                    : 'border-slate-200 focus:border-indigo-600 focus:ring-indigo-600/10'
                    }`}
            ...
            {googleClientId ? (
              ...
              <div className="text-center rounded-xl bg-amber-50 border border-amber-200/50 p-3 text-xs font-semibold text-amber-700">
                Configure VITE_GOOGLE_CLIENT_ID to activate Google sign-up.
              </div>
            )}
